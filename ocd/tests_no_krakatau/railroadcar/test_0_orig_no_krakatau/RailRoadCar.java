class RailRoadCar {
    ...
    public static java.util.LinkedList Rearrange(java.util.LinkedList a)
    {
        ...
        while(true)
        {
            ...
            while(i0 < i)
            {
                ...
                else if (Integer.parseInt(a2.element().toString()) < Integer.parseInt(a.element().toString()))
                {
                    a1.add(a2.element());
                    a2.remove();
                    a2.add(a.element());
    ...
    public static void main(String[] a)
    {
        ...
        try
        {
            ...
            while(i < s.length())
            {
                int i0 = s.charAt(i);
                int i1 = (char)i0;
                a1.add((Object)Character.valueOf((char)i1));
                i = i + 1;
            }
        }
        catch(Exception a2)
