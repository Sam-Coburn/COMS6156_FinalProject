class BubbleSort {
    ...
    public static void main(String[] a)
    {
        ...
        try
        {
            ...
            while((long)i < j)
            {
                System.out.print(new StringBuilder().append("Enter [").append(i + 1).append("] Element: ").toString());
            ...
            while((long)i0 < j)
            {
                ...
                System.out.print(new StringBuilder().append("After iteration ").append(i0).append(": ").toString());
                int i2 = 0;
                while((long)i2 < j)
                {
                    {
                ...
                System.out.println(new StringBuilder().append("/*** ").append(i0).append(" biggest number(s) is(are) pushed to the end of the array ***/").toString());
                i0 = i0 + 1;
            }
