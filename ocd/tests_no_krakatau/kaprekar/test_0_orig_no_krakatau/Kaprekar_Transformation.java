class Kaprekar_Transformation {
    ...
    static int ComputeKaprekarTranformation(int i)
    {
        int i0 = 0;
        int i1 = 0;
        int i2 = 0;
    ...
    public static void main(String[] a)
    {
        ...
        int i = Kaprekar_Transformation.ReadInteger();
        label0: {
            label2: {
                label1: {
                    if (i >= 0)
        ...
        while(true)
        {
            int i3 = Kaprekar_Transformation.ComputeKaprekarTranformation(i);
            if (i == i3)
            {
                return;
            }
